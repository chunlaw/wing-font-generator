...
- **Japanese (日本語)** — kana furigana from KanjiDic2, with 音読み rendered in katakana and 訓読み in hiragana so the script itself signals the reading type, plus 熟語 word-context rules aligned from JMdict (行 reads コウ in 銀行 / ギョウ in 行政 but いく on its own).
